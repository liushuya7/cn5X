...
class grblConfig(QObject):
  ...
  def on_ResetFactory(self):
    m = msgBox(
        title     = self.tr("Restore factory configuration"),
        text      = self.tr("Are you sure? \n Restoring the factory configuration restore all the parameters as they were when the Grbl microcode was generated."),
        info      = self.tr("All modifications and settings made on this instance of Grbl will be permanently lost!"),
